...
var appId = process.env.ABBYY_OCR_CLOUD_APP_ID;
// Password should be sent to your e-mail after application was created
var password = process.env.ABBYY_OCR_CLOUD_PASSWORD;

var imagePath = "./public/assets/image-cert.jpeg";
var outputPath = "./public/assets/output-2.xml";

const runAbbyy = (req, res) => {
  try {
    ...
    function processingCompleted(error, taskData) {
      ...
      ocrsdk.downloadResult(
        taskData.resultUrl.toString(),
        outputPath,
        downloadCompleted
      );
    }
    ...
    function uploadCompleted(error, taskData) {
      ...
      console.log(
        "Task id = " + taskData.id + ", status is " + taskData.status
      );
